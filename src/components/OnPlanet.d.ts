...
interface OnPlanetInterface extends ethers.utils.Interface {
  functions: {
...
export type BuyBackTriggerTokenLimitUpdatedEvent = TypedEvent<
  [BigNumber, BigNumber] & { prevValue: BigNumber; newValue: BigNumber }
>;
...
export type SwapETHForTokensEvent = TypedEvent<
  [BigNumber, string[]] & { amountIn: BigNumber; path: string[] }
>;
...
export class OnPlanet extends BaseContract {
  ...
  filters: {
    ...
    "TradingEnabled()"(): TypedEventFilter<[], {}>;
