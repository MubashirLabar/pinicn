      ...
      <div className="wrapper wrapWidth flex flex-col">
        <div className="section flex flex-col">
          <div className="title font s20 b6 c000">
            <span className="color">Lock</span> LP Tokens
          </div>
          ...
          <div className="ftr flex aic">
            <button className="button font cfff">Approve LP Token</button>
            <button className="button font cfff">Lock LP Tokens</button>
          </div>
        </div>
      </div>
    </div>
